...
class Particlefilter:
	 def __init__(self, _noise, _noOfParticles, _maze):
		...
		init_xcoordinates = (_maze.resolution) * 3  * np.random.random_sample(self.noOfParticles,)
		init_ycoordinates = (_maze.resolution) * 3  * np.random.random_sample(self.noOfParticles,)
